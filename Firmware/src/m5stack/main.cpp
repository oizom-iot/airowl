...
void setup() {
  ...
  // Get Mac Address to generate Unique Name
  String mac = WiFi.macAddress();
  mac.replace(":", "");
  String apName = "AIROWL_" + mac.substring(6);
  
  // Setup Wifi Manager NTP server
  ...
  {
    qrcodeurl = "https://opendata.oizom.com/device/" + apName;
  }
  else{
    qrcodeurl = "WIFI:T:WPA;S:" + apName + ";P:12345678;;";
  }
  ...
  // Initialize time and date from compiler
  time_init();
...
void loop() {  
  wm.process();  // Update Wifi Manager
